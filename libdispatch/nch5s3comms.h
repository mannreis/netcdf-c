...
EXTERNL s3r_t *NCH5_s3comms_s3r_open(const char* root, NCS3SVC svc, const char* region, const char* id, const char* access_key, struct NCauth *auth);

EXTERNL int NCH5_s3comms_s3r_close(s3r_t *handle);

EXTERNL int NCH5_s3comms_s3r_connect(s3r_t *handle, const char *url, const char **errmsg);
