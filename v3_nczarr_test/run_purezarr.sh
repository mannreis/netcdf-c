...
diff -b ${srcdir}/ref_purezarr$ZDF.cdl tmp_purezarr_${zext}.cdl
...
diff -b ${srcdir}/ref_xarray$ZDF.cdl tmp_xarray_${zext}.cdl
...
diff -b ${srcdir}/ref_nczarr2zarr$ZDF.cdl tmp_nczarr_${zext}.cdl
}
